...
//		------------------------------------------------------------------------------------------------------------------
//		------------------------------------------------------------------------------------------------------------------
//		 This code will allow to load data from datatbase and view into the tablview
...
//	 This code will allow to Edit Orders.
		...
		private void EditOrderTable(ActionEvent ev) {
			try {
				Parent parent=FXMLLoader.load(getClass().getResource("AdminEditTable.fxml"));
				...
				EditTableStage.setTitle("Edit Orders");
